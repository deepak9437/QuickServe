...
/**
 * Bean definitions for {@link ProviderRepository}.
 */
@Generated
public class ProviderRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'providerRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getProviderRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'providerRepository'.
   */
  public static BeanDefinition getProviderRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ProviderRepository.class, ProviderEntity.class, Integer.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "quick.serve.repo.ProviderRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.ProviderRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new quick.serve.repo.ProviderRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getProviderRepositoryInstanceSupplier();
